...
{
    /// <inheritdoc />
    public partial class SubindoDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarrosVendididosId = table.Column<int>(type: "int", nullable: false),
                    TaxaFixa = table.Column<double>(type: "double", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendas_Carros_CarrosVendididosId",
                        column: x => x.CarrosVendididosId,
                        principalTable: "Carros",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendas_CarrosVendididosId",
                table: "Vendas",
                column: "CarrosVendididosId");
